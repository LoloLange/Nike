...
export const Toast = ({ name, size, price, image, fadeout }) => {
  return name && size && price ? (
    <Link to={'/bag'} className={`flex items-center rounded-xl shadow-xl select-none absolute bottom-2 right-2 min-[768px]:bottom-5 min-[768px]:right-5 border-gray-100 border-2 animate-fade-in-left bg-white ${fadeout && 'animate-fade-out-right'} z-50`}>
      <img
